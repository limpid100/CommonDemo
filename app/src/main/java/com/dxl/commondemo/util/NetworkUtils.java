...
public class NetworkUtils {
    ...
    private static NetworkInfo getActiveNetworkInfo() {
        ConnectivityManager cm = (ConnectivityManager) CommonApp.getAppContext()
...
//    }
    ...
    public static boolean getDataEnabled() {
        try {
            TelephonyManager tm = (TelephonyManager) CommonApp.getAppContext().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static boolean getWifiEnabled() {
        WifiManager wifiManager = (WifiManager) CommonApp.getAppContext().getApplicationContext().getSystemService(Context.WIFI_SERVICE);
